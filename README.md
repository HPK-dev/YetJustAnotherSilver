...
Upon further investigation, we found that many tech mods need a common silver material,
...
This branch targets Fabric for Minecraft 1.19.3 and requires Java 17.
Create integration is disabled because no compatible Fabric Create release exists for Minecraft 1.19.3.
...
[Create]:https://modrinth.com/mod/create-fabric/versions?g=1.19.3
